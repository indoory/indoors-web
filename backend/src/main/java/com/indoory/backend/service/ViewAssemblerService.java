...
public class ViewAssemblerService {
  ...
  public ApiDtos.RobotSummaryResponse toRobotSummary(
      RobotEntity robot, TaskEntity activeTask, FloorEntity floor, MapEntity map) {
  ...
  public ApiDtos.RobotPoseResponse toRobotPose(
      RobotEntity robot, MapEntity map, FloorEntity floor) {
  ...
  public ApiDtos.EventLogResponse toEventLog(
      EventLogEntity event, RobotEntity robot, TaskEntity task) {
  ...
  public ApiDtos.FloorResponse toFloor(
      FloorEntity floor, List<ApiDtos.LocationResponse> locations) {
  ...
  public ApiDtos.MapRobotResponse toMapRobot(
      RobotEntity robot, FloorEntity floor, TaskEntity activeTask) {
  ...
  public ApiDtos.MapTaskResponse toMapTask(
      TaskEntity task, FloorEntity floor, RobotEntity assignedRobot) {
  ...
  private List<ApiDtos.TaskTimelineItemResponse> timeline(TaskEntity task) {
    return List.of(
        ...
        new ApiDtos.TaskTimelineItemResponse(
            ...
            task.getCurrentStage() == TaskStage.LOADING
                    || task.getCurrentStage() == TaskStage.ROUTE_TO_DROPOFF
                    || task.getCurrentStage() == TaskStage.COMPLETED
                ? task.getStageUpdatedAt()
                : null),
        new ApiDtos.TaskTimelineItemResponse(
            "dropoff",
